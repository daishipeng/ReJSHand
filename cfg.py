_CONFIG = dict(
    NAME="fastvit_ma36",  # repvit_m2_3
    TAG="fastvit_ma36 deconv4 one conv k44",
    MODEL=dict(
        NAME="HandNet",
        BACKBONE=dict(
            model_name="fastvit_ma36", #repvit_m2_3
            pretrain=True,
    ...
    DATA=dict(
        ...
        DATASET_DIR='/home/asrock/quanbao/daishipeng/simpleHand/dataset/FreiHAND/training/rgb/',
        JSON_DIR='/home/asrock/quanbao/daishipeng/simpleHand/dataset/FreiHAND/train.json',
    ...
    VAL=dict(
        BMK=dict(
            name="FreiHand",
			json_path='/home/asrock/quanbao/daishipeng/simpleHand/dataset/FreiHAND/eval.json',
            eval_dir="/home/asrock/quanbao/daishipeng/simpleHand/dataset/FreiHAND/evaluation/rgb/",
            scale_enlarge=1.25,
            ),
        IMAGE_SHAPE=(224, 224),
        BATCH_SIZE=64,
       ...
       VAL1=dict(
        BMK1=dict(
            name="test",
			json_dir='/home/asrock/quanbao/daishipeng/simpleHand/dataset/FreiHAND/test.json',
            eval_dir="/home/asrock/quanbao/daishipeng/simpleHand/dataset/FreiHAND/test",
            scale_enlarge=1.25,
            ),
        IMAGE_SHAPE=(224, 224),
        BATCH_SIZE=64,
